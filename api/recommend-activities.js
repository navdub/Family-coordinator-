...
return res.status(500).json({
error: ‘Invalid API key format. OpenAI keys should start with “sk-”. Please check your OPENAI_API_KEY environment variable.’
});
}
...
IMPORTANT: Return ONLY a valid JSON array. Start with [ and end with ]. No markdown, no explanations, just the JSON array.`}, { role: 'user', content:`Location: ${location}
Kids: ${kidsInfo}
